...
}`,...(N=(w=d.parameters)==null?void 0:w.docs)==null?void 0:N.source}}};var j,C,k;c.parameters={...c.parameters,docs:{...(j=c.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => {
    ...
    return <div className="max-w-sm mx-auto bg-neutral-50 rounded-xl overflow-hidden border border-neutral-200 relative" style={{
      minHeight: 360
        ...
        <div className="absolute bottom-0 left-0 right-0 flex gap-2 p-3 bg-white border-t border-neutral-200">
          {resolved.map(a => <Button key={a.id} variant={variantMap[a.variant] ?? "secondary"} density="touch" width="fill" disabled={a.disabled} className="flex-1">
              {a.label}
            </Button>)}
        </div>
      </div>;
  ...
  render: () => {
    ...
    return <TooltipProvider>
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2">
            <Button variant="destructive" density="compact" width="hug" onClick={() => setOpen(true)}>
              Post Document
            </Button>
